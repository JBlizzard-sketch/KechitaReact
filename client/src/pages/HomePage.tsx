...
import heroImage from '@assets/stock_images/kenyan_market_vendor_5fa12233.jpg';
    ...
    <>
      ...
      <div className="relative min-h-[600px] lg:min-h-[700px] flex items-center">
        <div className="absolute inset-0">
          <img src={heroImage} alt="Kenyan market" className="w-full h-full object-cover" />
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/apply">
                <Button size="lg" variant="default" className="bg-white text-primary hover:bg-white/90 border-2 border-white" data-testid="button-hero-apply">
                  {siteData.hero.cta1}
                </Button>
              </Link>
              <Link href="/loans">
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <Link href="/apply">
              <Button size="lg" data-testid="button-cta-apply">Apply for a Loan Today</Button>
            </Link>
          </motion.div>
        </div>
      </section>
